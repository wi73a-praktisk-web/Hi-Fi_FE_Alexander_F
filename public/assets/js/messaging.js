document.addEventListener('DOMContentLoaded', function () {
    ...
    fetch('http://95.85.49.133:8080/checkFlags/' + localStorage.getItem('userid'), {
            'method': 'get',
            'headers': {
...
document.querySelector('#new_message_btn').addEventListener('click', (event) => {
    ...
    fetch('http://95.85.49.133:8080/user', {
        ...
        document.getElementById('send_btn').addEventListener('click', event => {
            ...
            fetch('http://95.85.49.133:8080/sendMessage/' + localStorage.getItem('userid'), init)
                .then(() => {
...
document.querySelector('#inbox_btn').addEventListener('click', (event) => {
    event.preventDefault();
    document.querySelector('#content_div').innerHTML = '';
    fetch('http://95.85.49.133:8080/allInboxMessages/' + localStorage.getItem('userid'), {
        'method': 'get',
        'headers': {
            'Authorization': localStorage.getItem('token'),
            'userID': localStorage.getItem('userid'),
        ...
        messages.forEach(message => {
            let send_url;
            fetch('http://95.85.49.133:8080/getUserImage/' + message.sender, {
                    'method': 'get',
                    'headers': {
                        'Authorization': localStorage.getItem('token'),
                        'userID': localStorage.getItem('userid'),
                    ...
                    <row>   
                        <div id="div${message.id}" class="annoyingTheShitOutOfMe col-xs-12">
                            ...
                            <a id="${message.id}" onclick="viewSingleInboxMessage(this.id)" href="#">
                                <row>
                                    <div>
                                        <label>From:</label> <img src='http://95.85.49.133:8080/images/${send_url}' height="20" alt="henter billede"> <strong>${message.name}</strong> <br/>
...
document.querySelector('#outbox_btn').addEventListener('click', (event) => {
    event.preventDefault();
    document.querySelector('#content_div').innerHTML = '';
    fetch('http://95.85.49.133:8080/allOutboxMessages/' + localStorage.getItem('userid'), {
        'method': 'get',
        'headers': {
            'Authorization': localStorage.getItem('token'),
            'userID': localStorage.getItem('userid'),
...
function viewSingleInboxMessage(target_id) {
    ...
    fetch('http://95.85.49.133:8080/singleInboxMessage/' + target_id, {
            'method': 'get',
            'headers': {
                'Authorization': localStorage.getItem('token'),
                'userID': localStorage.getItem('userid'),
        ...
        .then(message => {
            ...
            fetch('http://95.85.49.133:8080/getUserImage/ ' + message[0].receiver, {
                'method': 'get',
                'headers': {
                    'Authorization': localStorage.getItem('token'),
                    'userID': localStorage.getItem('userid'),
            ...
            fetch('http://95.85.49.133:8080/getUserImage/' + message[0].sender, {
                'method': 'get',
                'headers': {
                    'Authorization': localStorage.getItem('token'),
                    'userID': localStorage.getItem('userid'),
                ...
                document.getElementById('view_message').innerHTML += `
                    ...
                    <div class="wrapper_div">
                        <div class="label_div">
                            ...
                            <label>From: <img src='http://95.85.49.133:8080/images/${send_url}' height="20" alt="henter billede"> </label> <span>${message[0].send}</span> <br/>
                            <label>To: <img src='http://95.85.49.133:8080/images/${rec_url}' height="20" alt="henter billede"> </label> <span>${message[0].rec}</span> <br/>
                        </div>
                        <p>
                            ${message[0].message}
                        </p>
...
function viewSingleOutboxMessage(target_id) {
    ...
    document.getElementById('view_message').innerHTML = '';
    //fetch that single message
    fetch('http://95.85.49.133:8080/singleOutboxMessage/' + target_id, {
            'method': 'get',
            'headers': {
                'Authorization': localStorage.getItem('token'),
                'userID': localStorage.getItem('userid'),
...
function deleteMessage(target_id) {
    ...
    fetch('http://95.85.49.133:8080/deleteMessage/' + target_id, {
            'method': 'post',
            'headers': {
                'Authorization': localStorage.getItem('token'),
                'userID': localStorage.getItem('userid'),
