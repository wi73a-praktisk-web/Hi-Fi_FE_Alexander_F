        ...
        .then(function (result) {
            ...
            products.forEach(product => {
                ...
                <tr class="prod_tr">
                    ...
                    <td>
                        <img src='http://95.85.49.133:8080/images/${product.billede}' height="75" width="200 "alt="henter billede">
                    </td>
                    <td>${product.Navn}
                    </td>
                    <td>${product.vareNr}
            ...
            fetch('http://95.85.49.133:8080/getAllCategories')
                .then(result => {
                    return result.json();
                }).then(categories => {
            ...
            fetch('http://95.85.49.133:8080/getAllProducers')
                .then(result => {
                    return result.json();
                }).then(producers => {
...
document.getElementById('users').addEventListener('click', (event) => {
    ...
    document.getElementById('edit_div').innerHTML = '';
    document.getElementById('content_div').innerHTML = '';
    fetch('http://95.85.49.133:8080/allUsers', {
        'method': 'post',
        'headers': {
        ...
        users.forEach(user => {
            ...
            <tr>
                ...
                <td>
                    <img src='http://95.85.49.133:8080/images/${user.url}' height="75" width="200 "alt="henter billede">
                </td>
                <td>${user.name}</td>
                <td>${user.username}</td>
                <td>${user.email}</td>
...
function delete_user(target_id) {
    fetch('http://95.85.49.133:8080/deleteUser/' + target_id, {
        'method': 'post',
        'headers': {
            'Authorization': localStorage.getItem('token'),
            'userID': localStorage.getItem('userid'),
    ...
    fetch('http://95.85.49.133:8080/user', {
        ...
        document.getElementById('edit_div').innerHTML += `
            ...
            <p>
                ...
                <img src="http://95.85.49.133:8080/images/${users[0].url}" id="old_pic" alt="billede hentes" width="200" height="75">
        ...
        document.querySelector('#register_user_btn').addEventListener("click", (event) => {
            ...
            let request = new Request(`http://95.85.49.133:8080/updateUser/${target_id}`, init);
...
function add_new_user() {
    ...
    document.querySelector('#register_user_btn').addEventListener("click", (event) => {
        ...
        let request = new Request('http://95.85.49.133:8080/registerUser', init);
...
function delete_product(target_id) {
    fetch('http://95.85.49.133:8080/deleteProduct/' + target_id, {
        'method': 'post',
        'headers': {
            'Authorization': localStorage.getItem('token'),
            'userID': localStorage.getItem('userid'),
...
function edit_product(target_id) {
    ...
    document.getElementById('edit_div').innerHTML = '';
    fetch('http://95.85.49.133:8080/product/' + target_id, {
        'method': 'get',
        'headers': {
            'Authorization': localStorage.getItem('token'),
            'userID': localStorage.getItem('userid'),
        ...
        document.getElementById('edit_div').innerHTML += `
            <form id="product_form" method="post" enctype="multipart/form-data">
                ...
                <label>Gammelt Billede</label>
                <img src="http://95.85.49.133:8080/images/${products[0].billede}" id="old_pic" alt="billede hentes" width="200" height="75">
                <label>Upload Nyt Billede</label>
        ...
        document.querySelector('#update_button').addEventListener('click', event => {
            ...
            if (!document.querySelector("#product_form").reportValidity()) {
                ...
                fetch('http://95.85.49.133:8080/updateProduct/' + target_id, {
                    "method": 'put',
                    "body": data,
                    'cache': 'no-cache'
                }).then(result => {
    ...
    fetch('http://95.85.49.133:8080/getAllCategories', {
        ...
        document.querySelector('#register_product_btn').addEventListener('click', (event) => {
            ...
            if (!document.querySelector("#product_form").reportValidity()) {
                ...
                let request = new Request('http://95.85.49.133:8080/registerProduct', init);
...
function delete_producer(target_id) {
    fetch('http://95.85.49.133:8080/deleteProducer/' + target_id, {
        'method': 'post',
        'headers': {
            'Authorization': localStorage.getItem('token'),
            'userID': localStorage.getItem('userid'),
...
function edit_producer(target_id) {
    ...
    document.getElementById('edit_div').innerHTML = '';
    fetch('http://95.85.49.133:8080/producer/' + target_id, {
        'method': 'get',
        'headers': {
            'Authorization': localStorage.getItem('token'),
            'userID': localStorage.getItem('userid'),
...
function update_producer(target_id) {
    fetch('http://95.85.49.133:8080/updateProducer/' + target_id, {
        'method': 'post',
        'headers': {
            'Authorization': localStorage.getItem('token'),
            'userID': localStorage.getItem('userid'),
...
function add_new_producer() {
    ...
    document.querySelector('#register_producer_btn').addEventListener('click', (event) => {
        ...
        let request = new Request('http://95.85.49.133:8080/registerProducer', init);
...
function delete_category(target_id) {
    fetch('http://95.85.49.133:8080/deleteCategory/' + target_id, {
        'method': 'post',
        'headers': {
            'Authorization': localStorage.getItem('token'),
            'userID': localStorage.getItem('userid'),
...
function edit_category(target_id) {
    document.getElementById('edit_div').innerHTML = '';
    fetch('http://95.85.49.133:8080/category/' + target_id, {
        'method': 'get',
        'headers': {
            'Authorization': localStorage.getItem('token'),
            'userID': localStorage.getItem('userid'),
...
function update_category(target_id) {
    fetch('http://95.85.49.133:8080/updateCategory/' + target_id, {
        'method': 'post',
        'headers': {
            'Authorization': localStorage.getItem('token'),
            'userID': localStorage.getItem('userid'),
...
function add_new_category() {
    ...
    document.querySelector('#register_category_btn').addEventListener('click', (event) => {
        ...
        let request = new Request('http://95.85.49.133:8080/registerCategory', init);
...
function handleClick(sender) {
    ...
    let request = new Request('http://95.85.49.133:8080/getFilteredProducts', init);
